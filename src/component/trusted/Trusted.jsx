...
import './trusted.css'
import sitejabber from '../img/sitejabber.png'
import google from '../img/google.png'
import trust from '../img/trust.png'
import tsh from '../img/tsh.png'

const Trusted = () => {
    return (
        <>
            <section className="truedby section-features pt-120 pb-120">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="trusted-block">
                                <div className="trusted-block-inner">
                                    ...
                                    <div className="review-count">1067 review</div>
